...
import { Settings, Moon, Sun, Heart, X, RefreshCw, ChevronRight, Plus, Minus } from "lucide-react";
import { getGreeting, getDaysInMonth } from "../lib/utils";
...
export function HomeTab() {
  ...
  const [showDessertToggle, setShowDessertToggle] = useState(false);
