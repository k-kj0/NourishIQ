  ...
  return (
    <div className="max-w-md mx-auto bg-[#fafaf8] min-h-screen pb-24">
      ...
      <div className="px-4">
        <div className="bg-white rounded-3xl p-5 shadow-sm mb-4">
          ...
          {!isEditing ? (
            <button
              ...
              className="w-full bg-green-500 hover:bg-green-600 text-white font-semibold py-3 rounded-2xl flex items-center justify-center gap-2 transition-colors"
            >
              <Settings size={18} />
              Edit Profile
            </button>
            ...
            <div className="space-y-3">
              <div>
                ...
                <input
                  ...
                  className="w-full p-3.5 rounded-2xl border-2 border-gray-200 focus:border-green-400 outline-none font-medium text-sm"
                />
              </div>
              <div>
                <label className="text-xs text-gray-500 block mb-1.5">Goal</label>
                <input
                  type="text"
                  value={editForm.goal}
              ...
              <div>
                <label className="text-xs text-gray-500 block mb-1.5">Target Calories</label>
                <input
                  type="number"
              ...
              <div className="flex gap-2">
                <button
                  onClick={handleSave}
                  className="flex-1 bg-green-500 text-white font-semibold py-3 rounded-2xl"
                >
                  Save
                </button>
                <button
                  onClick={() => setIsEditing(false)}
                  className="flex-1 bg-gray-100 text-gray-700 font-semibold py-3 rounded-2xl"
                >
                  Cancel
                </button>
              </div>
        ...
        <button
          onClick={resetApp}
          className="w-full bg-red-50 text-red-500 font-semibold py-3 rounded-2xl flex items-center justify-center gap-2 hover:bg-red-100 transition-colors"
        >
          <LogOut size={18} />
          Reset App
        </button>
